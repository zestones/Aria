...
import { EquipmentGrid } from "@/features/control-room/EquipmentGrid";
import type { AnomalyEvent } from "@/features/control-room/useAnomalyStream";
import type { EquipmentEntry } from "@/features/control-room/useEquipmentList";

const useAnomalyStreamMock = vi.hoisted(() => vi.fn());

vi.mock("@/features/control-room/useAnomalyStream", () => ({
